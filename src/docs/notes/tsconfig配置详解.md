...
* extend继承配置
* compileOnSave 让IDE在保存文件的时候根据tsconfig.json重新生成文件
* compilerOptions 编译选项，详见[compilerOptions]()
* files 指定一个包含相对或绝对文件路径的列表
* include 指定一个文件glob匹配模式列表
* exclude 指定一个文件glob匹配模式列表
* references 一个对象的数组，指明要引用的工程。
...
[参考链接](https://blog.csdn.net/qq_16051405/article/details/126671093)